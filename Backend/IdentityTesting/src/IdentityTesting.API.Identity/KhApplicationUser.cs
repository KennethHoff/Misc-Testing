...
public sealed class KhUserManager(IUserStore<KhApplicationUser> store,
        IOptions<IdentityOptions> optionsAccessor,
        IPasswordHasher<KhApplicationUser> passwordHasher,
        IEnumerable<IUserValidator<KhApplicationUser>> userValidators,
        IEnumerable<IPasswordValidator<KhApplicationUser>> passwordValidators,
        ILookupNormalizer keyNormalizer,
        IdentityErrorDescriber errors,
        IServiceProvider services,
        ILogger<UserManager<KhApplicationUser>> logger)
...
public sealed class KhRoleManager(IRoleStore<KhApplicationRole> store,
        IEnumerable<IRoleValidator<KhApplicationRole>> roleValidators,
        ILookupNormalizer keyNormalizer,
        IdentityErrorDescriber errors,
        ILogger<RoleManager<KhApplicationRole>> logger,
        IHttpContextAccessor contextAccessor)
    : AspNetRoleManager<KhApplicationRole>(store, roleValidators, keyNormalizer, errors, logger, contextAccessor);

public sealed class KhSignInManager(UserManager<KhApplicationUser> userManager,
        IHttpContextAccessor contextAccessor,
        IUserClaimsPrincipalFactory<KhApplicationUser> claimsFactory,
        IOptions<IdentityOptions> optionsAccessor,
        ILogger<SignInManager<KhApplicationUser>> logger,

...
This analyzer ensures all properties are either required. This is to prevent the use of the default value for a property, which can lead to unexpected behavior.
